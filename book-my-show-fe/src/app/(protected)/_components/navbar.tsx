          ...
          <div className="hidden md:flex items-center space-x-4 lg:space-x-8">
            {navItems.map((item) => (
              <Link
                ...
                href={item.path}
                className={cn(
                  "relative inline-block transition-all hover:text-[#9b4819] hover-underline-animation text-sm lg:text-base",
          ...
          <Sheet open={isOpen} onOpenChange={setIsOpen}>
            ...
            <SheetContent side="right" className="w-[280px] sm:w-[300px]">
              <div className="flex flex-col space-y-4 mt-8 px-2">
                {navItems.map((item) => (
                  <Link
                    ...
                    className={cn(
                      ...
                      pathname === item.path
                        ? "text-[#9b4819] bg-primary/10"
                        : "text-gray-700 hover:text-[#9b4819] hover:bg-primary/5"
                    )}
                ...
                <Button
                  variant="ghost"
                  className="w-full justify-start text-base font-medium text-gray-700 hover:text-[#9b4819] transition-colors border border-primary/20 hover:border-primary/40 hover:bg-primary/5 rounded-lg p-3 mt-2"
                  onClick={() => {
                    onOpen("");
                    setIsOpen(false);
                  }}
